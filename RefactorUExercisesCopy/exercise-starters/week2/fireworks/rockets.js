...
function launchRocket(){
    ...
    var initialVelocityX = Math.random()*6-3;
    var initialVelocityY = Math.random()*2-1;
    function shoot(){
        if (pos === 400){
            clearInterval(id);
            ...
            pos+= 1;
            rocket.style.bottom = pos*initialVelocityY - pos + 50 + "px";
            rocket.style.left = 50 + pos*10*initialVelocityX + "px";
